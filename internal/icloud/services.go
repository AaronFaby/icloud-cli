	...
	return []ServiceCapability{
		{
			...
			Operations: []string{
				...
				"messages:list", "messages:poll", "messages:get", "messages:search", "messages:send",
		...
		},
		{
			...
			Status:     "supported",
			Protocol:   "CalDAV",
			Operations: []string{"calendars:list", "events:list", "events:create", "events:update", "events:patch", "events:delete"},
		},
		{
			Service:    "contacts",
			Status:     "supported",
			Protocol:   "CardDAV",
			Operations: []string{"books:list", "contacts:list", "contacts:search", "contacts:get", "contacts:create", "contacts:update", "contacts:patch", "contacts:delete"},
		},
